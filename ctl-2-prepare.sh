...
ops_edit $mysql_server mysqld bind-address 0.0.0.0
ops_edit $mysql_server mysqld character-set-server utf8
ops_edit $mysql_server mysqld collation-server utf8_general_ci
